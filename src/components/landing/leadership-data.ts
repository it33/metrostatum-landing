...
export const BADGES = [
  ...
  {
    src: "images/awards/devies-2026-comms.jpg",
    alt: "2026 DEVIES Award — Best Innovation in Communication and Messaging, Mattermost Enterprise Advanced",
    label: "DEVIES Communication & Messaging",
    year: "2026",
    wide: true,
  },
  {
    src: "images/awards/devies-2026-itops.jpg",
    alt: "2026 DEVIES Award — Best Innovation in ITOps, Mattermost",

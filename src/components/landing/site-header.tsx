...
const LOGIN = "https://customers.mattermost.com/login";
        ...
        <div className="mx-auto flex h-[72px] max-w-[1200px] items-center gap-3 px-4 sm:px-6 lg:px-8">
          ...
          <div className="ml-auto hidden items-center gap-2 lg:flex">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="rounded-md px-3 py-2 text-[15px] font-medium text-[var(--color-black)]/90 hover:text-[var(--color-denim)]"
            >
              {t("nav.login")}
            </a>
            <a
      ...
      <div className={cn("border-b bg-white lg:hidden", open ? "block" : "hidden")}>
        <nav className="mx-auto max-h-[min(70vh,640px)] max-w-[1200px] overflow-y-auto px-4 py-3 sm:px-6">
          ...
          <div className="mt-4 flex flex-col gap-2 pb-2">
            <a href={LOGIN} target="_blank" rel="noreferrer" className="py-2 text-center text-[15px] font-medium text-[var(--color-denim)]">
              {t("nav.login")}
            </a>
